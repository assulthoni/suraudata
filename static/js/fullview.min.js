    ...
    n.extend(i.prototype, { init: function() { this.buildCache(), this.utilites(), this.settingUp(), this.bindEvents() }, destroy: function() { this.unbindEvents(), this.$views.removeData() }, buildCache: function() { this.$window = n(o), this.$document = n(r), this.$htmlBody = n("html, body"), this.$views = n(this.views), this.options.navbar !== l && "string" == typeof this.options.navbar && n(this.options.navbar).length && (this.$navbar = n(this.options.navbar)) }, utilites: function() { this.createDots = function() { var t = n("#fv-dots");
            ...
            e.$window.on("resize." + e._name, e.settingUp.bind(e)), null !== e.$dotsElement && e.$dotsElement.on("click." + e._name, function(t) { t.preventDefault(), n(":animated").length || (e.previousView = e.currentView, e.currentView = parseInt(n(this).attr("data-scroll")), e.scrollTo(e.currentView)) }), e.$anchors !== l && 0 < e.$anchors.length && e.$anchors.on("click." + e._name, function(t) { t.preventDefault(), n(":animated").length || (e.previousView = e.currentView, e.currentView = parseInt(n(this).attr("data-scroll")), e.scrollTo(e.currentView)) }), e.options.mouseScrolling && e.$window.on("DOMMouseScroll mousewheel." + e._name, function(t) { var i = t || o.event; "INPUT" != (i.target || i.srcElement).tagName.toUpperCase() && e.scrollByWheel(i) }), e.options.keyboardScrolling && e.$document.on("keydown." + e._name, function(t) { var i = t || o.event; if ("INPUT" != (i.target || i.srcElement).tagName.toUpperCase() && (!n(":animated").length && !e.isScrolling)) switch (i.keyCode ? i.keyCode : i.which) {
                    ...
                    case 33:
                        e.scrollUp(); break;
                    case 34:
                        e.scrollDown() } }), e.$views.on("touchstart." + e._name, function(t) { e.lastY = t.originalEvent.touches[0].clientY, e.lastX = t.originalEvent.touches[0].clientX }), e.options.touchScrolling && e.$views.on("touchend." + e._name, function(t) { var i, s = t || o.event; "INPUT" != (s.target || s.srcElement).tagName.toUpperCase() && (i = s.originalEvent.changedTouches[0].clientY, s.originalEvent.changedTouches[0].clientX < e.lastX || e.lastX, e.lastY > i + 25 ? e.scrollDown() : e.lastY < i - 25 && e.scrollUp()) }) }, unbindEvents: function() { this.$window.off("." + this._name), this.$document.off("." + this._name), this.$views.off("." + this._name) }, callback: function(t, i) { var s = this.options.onScrollStart,
                e = this.options.onScrollEnd; "function" == typeof e && "onScrollEnd" === t && e(this.$views.eq(this.currentView), this.$views.eq(this.previousView), i.direction), "function" == typeof s && "onScrollStart" === t && s(this.$views.eq(i.current), this.$views.eq(i.destination), i.direction) } }), n.fn.fullView = function(t) { return t === l || "object" == typeof t ? this.each(function() { n.data(this, s) || n.data(this, s, new i(this, t)) }) : this }, n.fn.fullView.defaults = { navbar: l, dots: !0, dotsPosition: "right", dotsTooltips: !1, easing: "linear", backToTop: !1, speed: 500, keyboardScrolling: !0, mouseScrolling: !0, touchScrolling: !0, onScrollEnd: null, onScrollStart: null } }(jQuery, window, document);
